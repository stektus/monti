...
export default {
  ...
  Satellite: "Сателлит",
  "Encryption passphrase": "Парольная фраза шифрования",
  "An access grant is required.": "Нужен грант доступа.",
  "An API key and an encryption passphrase are required.":
    "Нужны ключ API и парольная фраза шифрования.",
  ...
  "E-mail": "Почта",
  "E-mail and password are required.": "Нужны почта и пароль.",

  "proton.password": `Пароль от учётной записи. Двухпарольный режим Proton,
    где у почтового ящика свой второй пароль, не поддерживается.`,
  "proton.2fa": `Код используется один раз, прямо сейчас, — нажмите
    «Подключить», пока он ещё действителен. Дальше Proton впускает Monti сам.`,
  "Two-factor code": "Код двухфакторной аутентификации",
  "(only if your account asks for one)": "(только если ваша учётная запись его просит)",
  ...
  "last sync failed {when}: {error}":
    "последняя синхронизация не удалась {when}: {error}",
  ...
  "the two sides no longer line up — the next run compares them from scratch":
    "стороны больше не сходятся — следующий запуск сравнит их заново",
