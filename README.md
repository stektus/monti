...
OneDrive (experimental), Backblaze B2, and self-hosted storage: WebDAV /
Nextcloud, S3-compatible, SFTP.
...
- [x] WebDAV, S3-compatible, SFTP, Backblaze B2, MEGA, Proton Drive and Koofr support
...
- [ ] More providers (Jottacloud, Storj, …)
