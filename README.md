...
Storj, OneDrive (experimental), Backblaze B2, and self-hosted storage: WebDAV
...
- [x] WebDAV, S3-compatible, SFTP, Backblaze B2, MEGA, Proton Drive, Koofr and Storj
